...
public class Tarnished extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = EldenRingSTS.makeID("CharacterID"); //This should match whatever you have in the CharacterStrings.json file
    private static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    private static final String[] NAMES = characterStrings.NAMES;
    private static final String[] TEXT = characterStrings.TEXT;

    //Image file paths
    private static final String SHOULDER_1 = EldenRingSTS.characterPath("shoulder.png"); //Shoulder 1 and 2 are used at rest sites.
    private static final String SHOULDER_2 = EldenRingSTS.characterPath("shoulder2.png");
    private static final String CORPSE = EldenRingSTS.characterPath("corpse.png"); //Corpse is when you die.
    ...
    public Tarnished() {
        super(NAMES[0], Enums.YOUR_CHARACTER,
                ...
                new SpriterAnimation(EldenRingSTS.characterPath("animation/default.scml"))); //Animation
