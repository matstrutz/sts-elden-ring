package eldenring.cards;

import basemod.abstracts.CustomCard;
import eldenring.EldenRingSTS;
import eldenring.util.CardInfo;
...
public abstract class BaseCard extends CustomCard {
    ...
    {
        super(EldenRingSTS.makeID(baseID), "", TextureLoader.getCardTextureString(baseID, cardType), cost, "", cardType, color, rarity, target);
    ...
    {
        super(EldenRingSTS.makeID(cardName), "", TextureLoader.getCardTextureString(cardName, cardType), cost, "", cardType, color, rarity, target);
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    EldenRingSTS.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
